...
class Project(models.Model):
    owner = models.ForeignKey(
        usermodel.Profile, on_delete=models.CASCADE, null=True, blank=True)
    ...
    image = models.ImageField(
        null=True, upload_to='projects', blank=True, default='default.jpg')
...
class review(models.Model):
    ...
    owner = models.ForeignKey(
        usermodel.Profile, on_delete=models.CASCADE, null=True)
